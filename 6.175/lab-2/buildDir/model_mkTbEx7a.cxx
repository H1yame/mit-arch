...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_tb_randomA_initialized__h838;
	 tUInt8 DEF_INST_top_DEF_tb_randomB_initialized__h1214;
	 tUInt8 DEF_INST_top_DEF_dut_busy__h1296;
	 INST_top.DEF__read__h196 = INST_top.INST_dut_i.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_dut_booth_step = (INST_top.DEF__read__h196) < (tUInt8)8u;
	 ...
	 DEF_INST_top_DEF_tb_randomA_initialized__h838 = INST_top.INST_tb_randomA_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 = !DEF_INST_top_DEF_tb_randomA_initialized__h838;
	 INST_top.DEF_WILL_FIRE_RL_tb_randomA_every_1 = INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1;
	 DEF_INST_top_DEF_tb_randomB_initialized__h1214 = INST_top.INST_tb_randomB_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomB_every_1 = !DEF_INST_top_DEF_tb_randomB_initialized__h1214;
	 ...
	 INST_top.DEF_x__h2166 = INST_top.INST_tb_read_count.METH_read();
	 INST_top.DEF_tb_read_count_5_EQ_128___d56 = (INST_top.DEF_x__h2166) == 128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_read = INST_top.INST_tb_operands_fifo.METH_i_notEmpty() && (!(INST_top.DEF_tb_read_count_5_EQ_128___d56) && (INST_top.DEF__read__h196) == (tUInt8)8u);
	 ...
	 INST_top.DEF_x__h1629 = INST_top.INST_tb_feed_count.METH_read();
	 INST_top.DEF_x_wget__h1090 = INST_top.INST_tb_randomB_zaz.METH_wget();
	 INST_top.DEF_x_wget__h713 = INST_top.INST_tb_randomA_zaz.METH_wget();
	 DEF_INST_top_DEF_dut_busy__h1296 = INST_top.INST_dut_busy.METH_read();
	 INST_top.DEF_tb_randomA_zaz_whas____d19 = INST_top.INST_tb_randomA_zaz.METH_whas();
	 INST_top.DEF_v__h1220 = INST_top.INST_tb_randomB_zaz.METH_whas() ? INST_top.DEF_x_wget__h1090 : (tUInt8)0u;
	 INST_top.DEF_IF_tb_randomA_zaz_whas__9_THEN_tb_randomA_zaz__ETC___d21 = INST_top.DEF_x_wget__h713;
	 INST_top.DEF_v__h844 = INST_top.DEF_tb_randomA_zaz_whas____d19 ? INST_top.DEF_IF_tb_randomA_zaz_whas__9_THEN_tb_randomA_zaz__ETC___d21 : (tUInt8)0u;
	 INST_top.DEF_IF_tb_randomA_zaz_whas__9_THEN_IF_tb_randomA_z_ETC___d30 = (INST_top.DEF_v__h844) == (tUInt8)128u;
	 INST_top.DEF_IF_tb_randomB_zaz_whas__7_THEN_tb_randomB_zaz__ETC___d31 = (INST_top.DEF_v__h1220) == (tUInt8)128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_feed = ((DEF_INST_top_DEF_tb_randomA_initialized__h838 && (DEF_INST_top_DEF_tb_randomB_initialized__h1214 && ((INST_top.DEF_IF_tb_randomA_zaz_whas__9_THEN_IF_tb_randomA_z_ETC___d30 || INST_top.DEF_IF_tb_randomB_zaz_whas__7_THEN_tb_randomB_zaz__ETC___d31) || INST_top.INST_tb_operands_fifo.METH_i_notFull()))) && (!((INST_top.DEF_x__h1629) == 128u) && !DEF_INST_top_DEF_dut_busy__h1296)) && !(INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1);
...
time_t MODEL_mkTbEx7a::get_creation_time()
{
  ...
  /* Sun Jan 28 14:02:21 UTC 2024 */
  return 1706450541llu;
}
