...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_tb_randomA_initialized__h881;
	 tUInt8 DEF_INST_top_DEF_tb_randomB_initialized__h1257;
	 tUInt8 DEF_INST_top_DEF_dut_busy__h1339;
	 INST_top.DEF_x__h278 = INST_top.INST_dut_i.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_dut_mul_step = (INST_top.DEF_x__h278) < (tUInt8)8u;
	 ...
	 DEF_INST_top_DEF_tb_randomA_initialized__h881 = INST_top.INST_tb_randomA_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 = !DEF_INST_top_DEF_tb_randomA_initialized__h881;
	 INST_top.DEF_WILL_FIRE_RL_tb_randomA_every_1 = INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1;
	 DEF_INST_top_DEF_tb_randomB_initialized__h1257 = INST_top.INST_tb_randomB_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomB_every_1 = !DEF_INST_top_DEF_tb_randomB_initialized__h1257;
	 ...
	 INST_top.DEF_x__h2521 = INST_top.INST_tb_read_count.METH_read();
	 INST_top.DEF_tb_read_count_8_EQ_128___d49 = (INST_top.DEF_x__h2521) == 128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_read = INST_top.INST_tb_operands_fifo.METH_i_notEmpty() && (!(INST_top.DEF_tb_read_count_8_EQ_128___d49) && (INST_top.DEF_x__h278) == (tUInt8)8u);
	 ...
	 INST_top.DEF_x__h1668 = INST_top.INST_tb_feed_count.METH_read();
	 INST_top.DEF_x_wget__h1133 = INST_top.INST_tb_randomB_zaz.METH_wget();
	 INST_top.DEF_x_wget__h756 = INST_top.INST_tb_randomA_zaz.METH_wget();
	 DEF_INST_top_DEF_dut_busy__h1339 = INST_top.INST_dut_busy.METH_read();
	 INST_top.DEF_v__h1263 = INST_top.INST_tb_randomB_zaz.METH_whas() ? INST_top.DEF_x_wget__h1133 : (tUInt8)0u;
	 INST_top.DEF_v__h887 = INST_top.INST_tb_randomA_zaz.METH_whas() ? INST_top.DEF_x_wget__h756 : (tUInt8)0u;
	 INST_top.DEF_IF_tb_randomA_zaz_whas__7_THEN_tb_randomA_zaz__ETC___d27 = (INST_top.DEF_v__h887) == (tUInt8)128u;
	 INST_top.DEF_IF_tb_randomB_zaz_whas__4_THEN_tb_randomB_zaz__ETC___d28 = (INST_top.DEF_v__h1263) == (tUInt8)128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_feed = ((DEF_INST_top_DEF_tb_randomA_initialized__h881 && (DEF_INST_top_DEF_tb_randomB_initialized__h1257 && ((INST_top.DEF_IF_tb_randomA_zaz_whas__7_THEN_tb_randomA_zaz__ETC___d27 || INST_top.DEF_IF_tb_randomB_zaz_whas__4_THEN_tb_randomB_zaz__ETC___d28) || INST_top.INST_tb_operands_fifo.METH_i_notFull()))) && (!((INST_top.DEF_x__h1668) == 128u) && !DEF_INST_top_DEF_dut_busy__h1339)) && !(INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1);
	 ...
	 {
	   INST_top.INST_dut_a_reg.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_dut_b_reg.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_dut_product.rst_tick__clk__1((tUInt8)1u);
...
time_t MODEL_mkTbEx5::get_creation_time()
{
  ...
  /* Sun Jan 28 09:02:40 UTC 2024 */
  return 1706432560llu;
}
