 ...
 * 
 * On Sun Jan 28 14:02:21 UTC 2024
 * 
 */
...
MOD_mkTbEx7a::MOD_mkTbEx7a(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    INST_dut_m_neg(simHdl, "dut_m_neg", this, 17u, 0u, (tUInt8)0u),
    INST_dut_m_pos(simHdl, "dut_m_pos", this, 17u, 0u, (tUInt8)0u),
    INST_dut_p(simHdl, "dut_p", this, 17u, 0u, (tUInt8)0u),
...
{
  init_symbol(&symbols[0u], "_read__h196", SYM_DEF, &DEF__read__h196, 4u);
  ...
  init_symbol(&symbols[32u], "v__h1220", SYM_DEF, &DEF_v__h1220, 8u);
  init_symbol(&symbols[33u], "v__h844", SYM_DEF, &DEF_v__h844, 8u);
  ...
  init_symbol(&symbols[44u], "x_wget__h1090", SYM_DEF, &DEF_x_wget__h1090, 8u);
  init_symbol(&symbols[45u], "x_wget__h713", SYM_DEF, &DEF_x_wget__h713, 8u);
}


/* Rule actions */

void MOD_mkTbEx7a::RL_dut_booth_step()
{
  tUInt8 DEF_x__h300;
  tUInt32 DEF_x__h231;
  tUInt32 DEF_p_next___1__h291;
  tUInt32 DEF__theResult____h216;
  tUInt32 DEF_p_next__h289;
  tUInt32 DEF_IF_dut_p_BITS_1_TO_0_EQ_0b10_THEN_IF_dut_p_BIT_ETC___d12;
  tUInt8 DEF_pr__h214;
  tUInt32 DEF__read__h56;
  tUInt32 DEF__read__h89;
  ...
  DEF_p_next___1__h291 = 131071u & (DEF_x__h1711 + DEF__read__h56);
  DEF__theResult____h216 = DEF_pr__h214 == (tUInt8)1u ? DEF_p_next___1__h291 : DEF_x__h1711;
  DEF_p_next__h289 = 131071u & (DEF__theResult____h216 + DEF__read__h89);
  switch (DEF_pr__h214) {
  case (tUInt8)2u:
  ...
  DEF_x__h231 = primShiftRA32(17u,
			      17u,
			      (tUInt32)(DEF_IF_dut_p_BITS_1_TO_0_EQ_0b10_THEN_IF_dut_p_BIT_ETC___d12),
			      32u,
			      1u);
  DEF_x__h300 = (tUInt8)15u & (DEF__read__h196 + (tUInt8)1u);
...
{
  tUInt8 DEF_new_value__h812;
  if (!(PORT_RST_N == (tUInt8)0u))
    DEF_v__h770 = rand32();
  DEF_new_value__h812 = (tUInt8)((tUInt8)255u & DEF_v__h770);
...
void MOD_mkTbEx7a::RL_tb_randomA_every_1()
{
  ...
  DEF_v__h844 = DEF_tb_randomA_zaz_whas____d19 ? DEF_IF_tb_randomA_zaz_whas__9_THEN_tb_randomA_zaz__ETC___d21 : (tUInt8)0u;
...
void MOD_mkTbEx7a::RL_tb_randomB_every_1()
{
  ...
  DEF_v__h1220 = INST_tb_randomB_zaz.METH_whas() ? DEF_x_wget__h1090 : (tUInt8)0u;
...
void MOD_mkTbEx7a::RL_tb_feed()
{
  ...
  tUInt32 DEF_x__h1525;
  tUInt32 DEF_x__h1560;
  tUInt32 DEF_x__h1586;
  ...
  DEF_IF_tb_randomA_zaz_whas__9_THEN_tb_randomA_zaz__ETC___d21 = DEF_x_wget__h713;
  DEF_v__h844 = DEF_tb_randomA_zaz_whas____d19 ? DEF_IF_tb_randomA_zaz_whas__9_THEN_tb_randomA_zaz__ETC___d21 : (tUInt8)0u;
  DEF_IF_tb_randomA_zaz_whas__9_THEN_IF_tb_randomA_z_ETC___d30 = DEF_v__h844 == (tUInt8)128u;
  DEF_IF_tb_randomB_zaz_whas__7_THEN_tb_randomB_zaz__ETC___d31 = DEF_v__h1220 == (tUInt8)128u;
  ...
  DEF_x__h1586 = 131071u & (((((tUInt32)((tUInt8)0u)) << 9u) | (((tUInt32)(DEF_v__h1220)) << 1u)) | (tUInt32)((tUInt8)0u));
  DEF_x__h1525 = 131071u & (((tUInt32)(DEF_v__h844)) << 9u);
  DEF_x__h1560 = 131071u & (((tUInt32)(DEF_tb_randomA_zaz_whas____d19 ? (tUInt8)255u & -DEF_IF_tb_randomA_zaz_whas__9_THEN_tb_randomA_zaz__ETC___d21 : (tUInt8)0u)) << 9u);
  DEF_IF_tb_randomA_zaz_whas__9_THEN_IF_tb_randomA_z_ETC___d47 = 65535u & ((((tUInt32)(DEF_v__h844)) << 8u) | (tUInt32)(DEF_v__h1220));
...
void MOD_mkTbEx7a::RL_tb_read()
{
  ...
  tUInt8 DEF_NOT_dut_p_BITS_16_TO_1_1_EQ_SEXT_tb_operands_f_ETC___d73;
  ...
  tUInt32 DEF_signed_dut_p_BITS_16_TO_1_1___d72;
  tUInt32 DEF_expected__h1717;
  tUInt32 DEF_signed_SEXT_tb_operands_fifo_first__2_BITS_15_ETC___d74;
  tUInt8 DEF_dut_p_BITS_16_TO_1_1_EQ_SEXT_tb_operands_fifo__ETC___d69;
  DEF_x__h2166 = INST_tb_read_count.METH_read();
  DEF_x__h1711 = INST_dut_p.METH_read();
  DEF_v__h1673 = (tUInt32)(DEF_x__h1711 >> 1u);
  DEF_signed_dut_p_BITS_16_TO_1_1___d72 = DEF_v__h1673;
  DEF_tb_operands_fifo_first____d62 = INST_tb_operands_fifo.METH_first();
  DEF_a__h1648 = (tUInt8)(DEF_tb_operands_fifo_first____d62 >> 8u);
  DEF_signed_tb_operands_fifo_first__2_BITS_15_TO_8_3___d70 = DEF_a__h1648;
  DEF_b__h1649 = (tUInt8)((tUInt8)255u & DEF_tb_operands_fifo_first____d62);
  DEF_expected__h1717 = (tUInt32)(65535u & (primSignExt32(16u,
							  8u,
							  (tUInt8)(DEF_a__h1648)) * primSignExt32(16u,
												  8u,
												  (tUInt8)(DEF_b__h1649))));
  DEF_dut_p_BITS_16_TO_1_1_EQ_SEXT_tb_operands_fifo__ETC___d69 = DEF_v__h1673 == DEF_expected__h1717;
  DEF_signed_SEXT_tb_operands_fifo_first__2_BITS_15_ETC___d74 = DEF_expected__h1717;
  DEF_signed_tb_operands_fifo_first__2_BITS_7_TO_0_5___d71 = DEF_b__h1649;
  DEF_NOT_dut_p_BITS_16_TO_1_1_EQ_SEXT_tb_operands_f_ETC___d73 = !DEF_dut_p_BITS_16_TO_1_1_EQ_SEXT_tb_operands_fifo__ETC___d69;
  DEF_x__h2042 = DEF_x__h2166 + 1u;
  INST_tb_operands_fifo.METH_deq();
  INST_dut_busy.METH_write((tUInt8)0u);
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    if (DEF_dut_p_BITS_16_TO_1_1_EQ_SEXT_tb_operands_fifo__ETC___d69)
    ...
    if (DEF_dut_p_BITS_16_TO_1_1_EQ_SEXT_tb_operands_fifo__ETC___d69)
      dollar_display(sim_hdl,
		     ...
		     DEF_signed_dut_p_BITS_16_TO_1_1___d72);
    if (DEF_dut_p_BITS_16_TO_1_1_EQ_SEXT_tb_operands_fifo__ETC___d69)
      dollar_display(sim_hdl,
		     this,
		     "s,8,8,16",
		     ...
		     DEF_b__h1649,
		     DEF_v__h1673);
    if (DEF_NOT_dut_p_BITS_16_TO_1_1_EQ_SEXT_tb_operands_f_ETC___d73)
...
unsigned int MOD_mkTbEx7a::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "_read__h196", 4u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_mkTbEx7a::vcd_defs(tVCDDumpType dt, MOD_mkTbEx7a &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF_WILL_FIRE_RL_tb_read = DEF_WILL_FIRE_RL_tb_read;
      ...
      {
	vcd_write_val(sim_hdl, num, DEF__read__h196, 4u);
	...
	backing.DEF_v__h1147 = DEF_v__h1147;
      ...
      {
	vcd_write_val(sim_hdl, num, DEF_v__h1220, 8u);
	...
	backing.DEF_v__h770 = DEF_v__h770;
      ...
      {
	vcd_write_val(sim_hdl, num, DEF_v__h844, 8u);
	...
	backing.DEF_x__h1629 = DEF_x__h1629;
      ...
      {
	vcd_write_val(sim_hdl, num, DEF_x__h1711, 17u);
	...
	backing.DEF_x_wget__h1090 = DEF_x_wget__h1090;
      ...
      {
	vcd_write_val(sim_hdl, num, DEF_x_wget__h713, 8u);
